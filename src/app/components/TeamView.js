...
export default function TeamView({ team: initialTeam, user, onBack, onUpdate }) {
  ...
  const handleRemoveMember = (memberId, memberName) => {
    ...
    setConfirmState({
      open: true,
      message: `Êtes-vous sûr de vouloir retirer ${memberName || "ce membre"} de la team ?`,
      onConfirm: async () => {
  ...
  const handleLeaveTeam = () => {
    setConfirmState({
      open: true,
      message: "Êtes-vous sûr de vouloir quitter cette team ?",
      onConfirm: async () => {
        setConfirmState({ open: false, message: "", onConfirm: null });
  ...
  const handleDeleteTeam = () => {
    ...
    setConfirmState({
      open: true,
      message: "Êtes-vous sûr de vouloir supprimer cette team ? Cette action est irréversible.",
      onConfirm: async () => {
        setConfirmState({ open: false, message: "", onConfirm: null });
