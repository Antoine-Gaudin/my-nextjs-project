...
export function ToastProvider({ children }) {
  ...
  // Actually let's just pass addToast + helpers directly

  return (
    <ToastContext.Provider value={{ addToast, removeToast, toast: { success: (msg, dur) => addToast(msg, "success", dur), error: (msg, dur) => addToast(msg, "error", dur), info: (msg, dur) => addToast(msg, "info", dur), warning: (msg, dur) => addToast(msg, "warning", dur) } }}>
      {children}
